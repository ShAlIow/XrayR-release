...
Find the source code here: [ShAlIow/XrayR](https://github.com/ShAlIow/XrayR)
...
```
bash <(curl -Ls https://raw.githubusercontent.com/ShAlIow/XrayR-release/refs/heads/master/install.sh)
```
# Docker 安装
...
```
1. `git clone https://github.com/ShAlIow/XrayR-release`
2. `cd XrayR-release`
3. 编辑config。
